      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <motion.div
            ...
            className="space-y-7"
          >
            <span className="inline-block px-4 py-1.5 bg-dream-logo-yellow-light/30 text-secondary font-semibold text-xs rounded-full uppercase tracking-wider">
              Who We Are
            </span>
            ...
            <div className="pt-5">
              <Link to="/about">
                <Button size="lg" variant="outline" className="border-2 border-primary text-primary hover:bg-primary/10 rounded-full px-8 py-3 text-base font-semibold shadow-md hover:shadow-lg transition-all transform hover:scale-105 group">
                  Learn More About Us <Heart className="ml-2 h-4 w-4 group-hover:fill-primary/20 transition-colors"/>
                </Button>
              </Link>
            </div>
          </motion.div>
