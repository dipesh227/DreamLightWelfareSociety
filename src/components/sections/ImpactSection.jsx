...
const ImpactStatCard = ({ icon: Icon, value, label, iconColor, bgColor, delay }) => (
  <motion.div 
    ...
    className="text-center bg-white p-6 md:p-8 rounded-2xl shadow-xl card-hover border-t-4 border-transparent hover:border-primary transition-all"
  >
    ...
    <h3 className="text-2xl md:text-3xl font-bold text-secondary-foreground mb-2">{value}</h3>
...
const ImpactSection = () => {
  const stats = [
    { icon: Users, value: "75,000+", label: "Lives Impacted in India", iconColor: "text-primary", bgColor: "bg-dream-logo-blue/20", delay: 0 },
    ...
    { icon: Globe, value: "30+", label: "Communities Empowered", iconColor: "text-secondary", bgColor: "bg-dream-logo-yellow/20", delay: 0.3 },
  ];
  ...
  return (
    <section id="impact" className="py-20 md:py-28 bg-gradient-to-b from-slate-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block px-4 py-1.5 bg-dream-logo-yellow-light/30 text-dream-logo-yellow font-semibold text-xs rounded-full uppercase tracking-wider mb-3.5">
            Real Results
          </span>
          <h2 className="text-4xl md:text-5xl font-bold text-secondary-foreground mb-5 md:mb-7">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 text-white p-3 bg-black/30 rounded-lg backdrop-blur-sm">
                <div className="flex items-center text-sm font-medium text-dream-logo-yellow-light mb-1">
          ...
          <div className="space-y-8">
            {testimonials.map((testimonial, index) => (
              <motion.div 
                key={index} 
                className="bg-white p-6 md:p-8 rounded-xl shadow-lg glass-effect border border-primary/10 card-hover"
              ...
              >
                ...
                <p className="font-semibold text-secondary-foreground text-sm">- {testimonial.author}</p>
              </motion.div>
            ))}
          </div>
        </div>
