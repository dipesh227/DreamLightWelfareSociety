    ...
    <div className="bg-slate-50">
      <header className="relative py-24 md:py-32 bg-gradient-to-br from-dream-gold to-dream-gold-light text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            Discover the comprehensive programs designed by Dreamlight Welfare Society to address critical community needs and foster sustainable, positive change in Uttarakhand.
          </motion.p>
        </div>
      </header>
