...
export default function AboutSection({ id = "about" }) {
  return (
    <section id={id} className="py-20 md:py-28 bg-white overflow-hidden">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <motion.div
            ...
            className="space-y-7"
          >
            <span className="inline-block px-4 py-1.5 bg-dream-gold/30 text-dream-gold font-semibold text-xs rounded-full uppercase tracking-wider">
              Who We Are
            </span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-dream-deep-purple leading-tight">
            ...
            <div className="space-y-5 pt-4">
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <div className="flex-shrink-0 bg-dream-purple/10 p-3.5 rounded-full mt-1 shadow-sm">
                  <Target className="h-6 w-6 text-dream-purple" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-dream-deep-purple">Our Vision</h3>
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <div className="flex-shrink-0 bg-dream-gold/20 p-3.5 rounded-full mt-1 shadow-sm">
                  <Globe className="h-6 w-6 text-dream-gold" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-dream-deep-purple">Our Mission</h3>
            ...
            <div className="pt-5">
              <Link href="/about">
                <button className="border-2 border-dream-purple text-dream-purple hover:bg-dream-purple/10 rounded-full px-8 py-3 text-base font-semibold shadow-md hover:shadow-lg transition-all transform hover:scale-105 group flex items-center">
                  Learn More About Us <Heart className="ml-2 h-4 w-4 group-hover:fill-dream-purple/20 transition-colors"/>
                </button>
              </Link>
            </div>
          </motion.div>
