...
const ImpactStatCardBig = ({ icon: Icon, value, label, description, iconColor, bgColor, delay = 0 }) => (
  ...
  >
    ...
    <h3 className="text-4xl md:text-5xl font-bold text-dws-blue-dark mb-2">{value}</h3>
...
const TestimonialCard = ({ quote, author, role, imageSrc, delay = 0 }) => (
  <motion.div 
    ...
    transition={{ duration: 0.6, delay }}
  >
    <div className="absolute -top-5 -left-5 bg-dws-gold text-white p-3 rounded-full shadow-lg">
    ...
    <div className="text-right md:text-left md:clear-left">
      <p className="font-bold text-dws-blue-dark text-md">- {author}</p>
...
const ImpactPage = () => {
  const stats = [
    { icon: Users, value: "75,000+", label: "Lives Transformed", description: "Directly impacting individuals and families through our diverse programs.", iconColor: "text-dws-blue-dark", bgColor: "bg-dws-blue-light/20", delay: 0 },
    { icon: BookOpen, value: "350+", label: "Educational Initiatives", description: "Supporting schools, literacy programs, and vocational training centers.", iconColor: "text-dws-green", bgColor: "bg-dws-green/10", delay: 0.1 },
    ...
    { icon: Globe, value: "40+", label: "Communities Empowered", description: "Working closely with villages and urban settlements to foster sustainable development.", iconColor: "text-dws-gold", bgColor: "bg-dws-gold/10", delay: 0.3 },
  ];
  ...
  return (
    <div className="bg-slate-50">
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 md:mb-20">
            <h2 className="text-3xl md:text-4xl font-bold text-dws-blue-dark mb-4">Our Impact by the Numbers</h2>
          ...
          <div className="mb-16 md:mb-24">
            <h2 className="text-3xl md:text-4xl font-bold text-dws-blue-dark text-center mb-12">Voices from the Community</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center bg-white p-8 md:p-12 rounded-2xl shadow-xl">
            ...
            >
              <h2 className="text-3xl font-bold text-dws-blue-dark mb-6">Our Commitment to Transparency</h2>
              ...
              <ul className="space-y-3 text-slate-600">
                <li className="flex items-start"><BarChart3 className="h-5 w-5 mr-3 mt-1 text-dws-blue-dark flex-shrink-0"/>Regular impact reports and financial disclosures.</li>
                <li className="flex items-start"><PieChart className="h-5 w-5 mr-3 mt-1 text-dws-gold flex-shrink-0"/>Clear breakdown of fund allocation for programs and operations.</li>
                <li className="flex items-start"><TrendingUp className="h-5 w-5 mr-3 mt-1 text-dws-green flex-shrink-0"/>Continuous monitoring and evaluation to improve program effectiveness.</li>
              </ul>
              <Link to="/contact#reports">
                <Button variant="link" className="text-dws-blue-dark mt-6 px-0">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-dws-gold to-dws-gold-light text-center">
        <div className="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8">
            <Users className="h-16 w-16 mx-auto mb-6 text-dws-blue-dark"/>
            <h2 className="text-3xl md:text-4xl font-bold text-dws-blue-dark mb-6">Be a Part of the Change</h2>
            <p className="text-lg md:text-xl mb-8 text-dws-blue-dark/90 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/donate">
                    <Button size="lg" className="bg-dws-blue-dark text-white hover:bg-dws-blue-dark/90 rounded-full px-10 py-3 text-base font-semibold w-full sm:w-auto">
                        Donate Now
                    </Button>
                </Link>
                 <Link to="/contact#volunteer">
                    <Button size="lg" variant="outline" className="border-2 border-dws-blue-dark text-dws-blue-dark hover:bg-dws-blue-dark/10 rounded-full px-10 py-3 text-base font-semibold w-full sm:w-auto">
                        Volunteer With Us
                    </Button>
                </Link>
            </div>
