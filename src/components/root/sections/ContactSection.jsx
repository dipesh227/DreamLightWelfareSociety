...
const ContactSection = () => {
  const contactDetails = [
    { icon: MapPin, title: "Address", lines: ["123 Welfare Street, Community Center", "New Delhi, India 110001"], iconBgColor: "bg-dws-blue-light/20", iconColor: "text-dws-blue-dark" },
    { icon: Phone, title: "Phone", lines: ["+91 98765 43210", "+91 87654 32109"], iconBgColor: "bg-dws-green/10", iconColor: "text-dws-green" },
    { icon: Mail, title: "Email", lines: ["info@dreamlightwelfare.org", "contact@dreamlightwelfare.org"], iconBgColor: "bg-dws-gold-light/20", iconColor: "text-dws-gold" },
  ];
              ...
              <form className="space-y-6" onSubmit={handleFormSubmit}>
                <div>
                  ...
                  <input 
                    ...
                    id="name"
                    name="name"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-dws-blue-dark focus:border-transparent"
