...
const PageHeader = ({ title, subtitle, icon: Icon, iconBgColor = "bg-dream-logo-blue-dark", iconColor = "text-dream-logo-yellow-light", gradientFrom = "from-primary", gradientTo = "to-dream-logo-blue-dark", bgPatternOpacity = "opacity-15" }) => {
  return (
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {subtitle && (
          <motion.p 
            ...
            className="text-lg md:text-xl max-w-3xl mx-auto text-dream-logo-yellow-light/90 leading-relaxed text-shadow-sm"
          >
            {subtitle}
          </motion.p>
        )}
