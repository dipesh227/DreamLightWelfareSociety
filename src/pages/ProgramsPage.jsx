...
const ProgramHighlightCard = ({ icon: Icon, title, description, imageSrc, imageAlt, bgColor, iconBgColor, linkTo, id }) => (
  ...
  >
    ...
    <div className="md:w-3/5 p-8 md:p-12">
      ...
      <h3 className="text-3xl font-bold text-dws-blue-dark mb-4">{title}</h3>
      <p className="text-slate-700 leading-relaxed mb-6">{description}</p>
      <Link to={linkTo}>
        <Button variant="outline" className="border-2 border-dws-blue-dark text-dws-blue-dark hover:bg-dws-blue-dark/10 rounded-full px-6 py-2">
          Learn More & Support
        </Button>
      </Link>
    </div>
...
const ProgramsPage = () => {
  const programs = [
    { 
      ...
      bgColor: "bg-dws-blue-light/10",
      iconBgColor: "bg-dws-blue-dark",
    ...
    { 
      ...
      bgColor: "bg-dws-green/10",
      iconBgColor: "bg-dws-green",
    ...
    { 
      ...
      imageSrc: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8aGVhbHRoJTIwY2FtcCUyMGluZGlhfGVufDB8fHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=70",
      imageAlt: "Healthcare worker conducting an awareness session in an Indian village",
      bgColor: "bg-dws-gold/10",
      iconBgColor: "bg-dws-gold",
  ...
  return (
    <div className="bg-slate-50">
      <PageHeader
        ...
        subtitle="Discover the comprehensive programs designed by Dreamlight Welfare Society to address critical community needs and foster sustainable, positive change in Uttarakhand."
        icon={Briefcase}
      ...
      <section className="py-16 md:py-24 bg-dws-blue-dark text-white">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Sun className="h-16 w-16 mx-auto mb-6 text-dws-gold-light"/>
