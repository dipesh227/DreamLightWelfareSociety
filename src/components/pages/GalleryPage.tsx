  ...
  return (<div className="bg-muted/30">
    ...
    <section className="py-16 md:py-24">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Category Filter */}
        <div className="mb-12">            <div className="flex items-center justify-center mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {categories.map(category => (
              <Button
                ...
                variant={selectedCategory === category ? "default" : "outline"} className={`rounded-full px-6 py-2 text-sm capitalize transition-all duration-300 ${selectedCategory === category
        ...
        >
          <AnimatePresence>
            {filteredImages.map((image) => (
              ...
              >
                <div className="aspect-w-16 aspect-h-12 relative overflow-hidden">                  <Image
                  src={image.src}
                  alt={image.alt}
                  fill
                ...
                <div className="p-4">
                  <span className="inline-block px-3 py-1 text-xs font-medium bg-dream-purple/10 text-dream-purple rounded-full capitalize">
                    {image.category}
                  </span>
                </div>
              </motion.div>
        ...
        </motion.div>        {filteredImages.length === 0 && (
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 z-10 p-2 bg-background/80 text-foreground rounded-full hover:bg-muted transition-colors"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            <div className="p-6">              <div className="flex items-center justify-between mb-2">
              ...
              <span className="px-3 py-1 text-sm font-medium bg-primary/10 text-primary rounded-full capitalize">
