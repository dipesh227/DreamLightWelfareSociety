...
const TransparencyPage = () => {
  ...
  const keyMetrics = [
    { icon: PieChart, value: "Est. 90%+", label: "Funds to Programs (Projected)", color: "text-green-600" },
    { icon: BarChart2, value: "Focused", label: "Impact in Uttarakhand", color: "text-dream-purple" },
    { icon: ShieldCheck, value: "100%", label: "Compliance with Societies Act", color: "text-blue-600" },
    { icon: Eye, value: "Full", label: "Commitment to Audit", color: "text-dream-gold" },
  ];
