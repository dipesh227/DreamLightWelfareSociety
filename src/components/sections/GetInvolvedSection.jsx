...
const GetInvolvedSection = ({ handleDonate, handleVolunteer }) => {
  const involvementOptions = [
    { 
      ...
      iconBgColor: "bg-gradient-to-br from-dream-logo-blue to-dream-logo-blue-light",
    },
    { 
      icon: Users, 
    ...
    { 
      ...
      linkTo: "/partnerships", 
      iconBgColor: "bg-gradient-to-br from-dream-logo-yellow to-dream-logo-yellow-light",
      borderColor: "border-dream-logo-yellow",
      textColor: "text-dream-logo-yellow",
      hoverBgColor: "bg-dream-logo-yellow"
    },
  ];
  ...
  return (
    <section className="py-20 md:py-28 bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <span className="inline-block px-4 py-1.5 bg-dream-logo-blue/10 text-dream-logo-blue font-semibold text-xs rounded-full uppercase tracking-wider mb-3.5">
            Join Our Mission
          </span>
