  ...
  return (
    <section id="impact" className="py-20 md:py-28 bg-gradient-to-b from-slate-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block px-4 py-1.5 bg-dream-logo-yellow-light/30 text-secondary font-semibold text-xs rounded-full uppercase tracking-wider mb-3.5">
            Real Results
          </span>
