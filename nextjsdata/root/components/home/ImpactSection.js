...
const ImpactStatCard = ({ icon: Icon, value, label, iconColor, bgColor, delay }) => (
  ...
  >
    ...
    <h3 className="text-2xl md:text-3xl font-bold text-dream-deep-purple mb-2">{value}</h3>
  ...
  return (
    <section id="impact" className="py-20 md:py-28 bg-gradient-to-b from-slate-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block px-4 py-1.5 bg-dream-gold/30 text-dream-gold font-semibold text-xs rounded-full uppercase tracking-wider mb-3.5">
            Real Results
          </span>
          <h2 className="text-4xl md:text-5xl font-bold text-dream-deep-purple mb-5 md:mb-7">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 text-white p-3 bg-black/30 rounded-lg backdrop-blur-sm">
                <div className="flex items-center text-sm font-medium text-dream-gold mb-1">
          ...
          <div className="space-y-8">
            {testimonials.map((testimonial, index) => (
              <motion.div 
                key={index} 
                className="bg-white p-6 md:p-8 rounded-xl shadow-lg border border-dream-purple/10 card-hover"
              ...
              >
                ...
                <p className="font-semibold text-dream-deep-purple text-sm">- {testimonial.author}</p>
              </motion.div>
            ))}
          </div>
        </div>
