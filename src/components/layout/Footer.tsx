...
const Footer: React.FC<FooterProps> = ({ logoUrl = '/logo1.jpeg' }) => {
  ...
  const involvedLinks = [
    { to: '/donate', label: 'Donate Now', icon: HandHeart },
  ...
  const handleNewsletterSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast({
      title: "Subscribed!",
      description: `Thank you for subscribing, ${email}! You'll receive our latest updates.`,
  ...
  return (
    <footer className="bg-gradient-to-br from-dream-purple-dark to-dream-purple text-slate-300 pt-20 pb-8 relative overflow-hidden">
      ...
      <motion.button
        onClick={scrollToTop}
        className="absolute bottom-6 right-6 bg-dream-gold text-dream-purple-dark p-3 rounded-full shadow-lg hover:bg-dream-gold-light transition-colors duration-300 z-20"
