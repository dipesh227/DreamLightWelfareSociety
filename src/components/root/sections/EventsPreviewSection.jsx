  ...
  >
    ...
    <div className="p-5 flex flex-col flex-grow">
      <div className="flex items-center text-xs text-slate-500 mb-1.5">
        <CalendarDays className="h-3.5 w-3.5 mr-1.5 text-dws-blue-dark" /> {date}
      </div>
      <div className="flex items-center text-xs text-slate-500 mb-3">
        <MapPin className="h-3.5 w-3.5 mr-1.5 text-dws-blue-dark" /> {location}
      </div>
      ...
      <Link to={linkTo} className="mt-auto self-start">
        <Button variant="link" size="sm" className="text-dws-blue-dark px-0 group/btn text-xs font-medium hover:text-dws-gold transition-colors">
...
const EventsPreviewSection = () => {
  const upcomingEvents = [
    ...
    { title: "Rural Health & Wellness Camp", date: "Nov 10, 2025", location: "Village Sariska, Rajasthan", description: "Free health check-ups, medicine distribution, and awareness sessions for all community members. Volunteers needed!", imagePlaceholder: "Indian doctor examining a child in a rural health camp setup with villagers in background", delay: 0.1 },
    { title: "Youth Employability Workshop", date: "Nov 18, 2025", time: "10:00 AM - 5:00 PM daily", location: "Dreamlight Center, Mumbai", description: "A 3-day intensive workshop for youth aged 16-24 focusing on digital literacy, communication skills, and entrepreneurship basics.", imagePlaceholder: "Young Indian students in a computer lab learning new skills with instructor", delay: 0.2 },
  ];

  return (
    <section className="py-20 md:py-28 bg-gradient-to-br from-dws-blue-dark to-dws-blue-light text-white overflow-hidden">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block px-4 py-1.5 bg-dws-gold/90 text-dws-blue-dark font-semibold text-xs rounded-full uppercase tracking-wider mb-3.5 shadow-sm">
            Stay Connected
          </span>
        ...
        <div className="text-center mt-14 md:mt-18">
            <Link to="/events">
                <Button size="lg" className="bg-dws-gold text-dws-blue-dark hover:bg-dws-gold-light rounded-full px-10 py-3.5 text-base font-semibold shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group">
